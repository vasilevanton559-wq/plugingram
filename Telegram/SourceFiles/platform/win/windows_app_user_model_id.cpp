...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"Plugingram.Plugingram.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"Plugingram.Plugingram";
#endif // OS_WIN_STORE
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"Plugingram Desktop/Plugingram.lnk"_q;
	const auto old = u"Plugingram/Plugingram.lnk"_q;
